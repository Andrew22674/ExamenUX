...
class MensajesPrivados extends Component {
    classes = {};
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        ...
        var userId = fire.auth().currentUser.uid;
        var ref = fire.database().ref().child("user-posts/" + userId + "/privado").orderByKey();

        //var ref = fire.database().ref().child("user-posts/" + userId).orderByValue(reverse);
...
export default withStyles(styles)(MensajesPrivados);
